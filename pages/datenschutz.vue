<template>
    <v-card class="ma-12" flat>
      <h2 class="text-uppercase section-heading">Datenschutzerklärung</h2>
      <p
        class="text-dark"
        style="
          margin: auto;
        ...
        "
      >
        <strong>1. Datenschutz auf einen Blick</strong><br /><br /><strong
          >Allgemeine Hinweise</strong
        ><br /><br />Die folgenden Hinweise geben einen einfachen Überblick
        darüber, was mit Ihren personenbezogenen Daten&nbsp;passiert, wenn Sie
        diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen
        Sie&nbsp;persönlich identifiziert werden können. Ausführliche
        Informationen zum Thema Datenschutz entnehmen&nbsp;Sie unserer unter
        diesem Text aufgeführten Datenschutzerklärung.<br /><br /><strong
          >Datenerfassung auf dieser Website</strong
        ><br /><br />Wer ist verantwortlich für die Datenerfassung auf dieser
        Website?<br /><br />Die Datenverarbeitung auf dieser Website erfolgt durch
        den Websitebetreiber. Dessen Kontaktdaten&nbsp;können Sie dem Abschnitt
        „Hinweis zur Verantwortlichen Stelle“ in dieser Datenschutzerklärung
        entnehmen.<br /><br />Wie erfassen wir Ihre Daten?<br /><br />Ihre Daten
        ...
        eingeben.<br />Andere Daten werden automatisch oder nach Ihrer
        ...
        automatisch, sobald Sie diese Website betreten.<br /><br />Wofür nutzen
        wir Ihre Daten?<br /><br />Ein Teil der Daten wird erhoben, um eine
        fehlerfreie Bereitstellung der Website zu gewährleisten. Andere&nbsp;Daten
        können zur Analyse Ihres Nutzerverhaltens verwendet werden.<br />Welche
        Rechte haben Sie bezüglich Ihrer Daten?<br />Sie haben jederzeit das
        Recht, unentgeltlich Auskunft über Herkunft, Empfänger und Zweck Ihrer<br />gespeicherten
        ...
        Ihrer personenbezogenen Daten zu verlangen.<br />Des Weiteren steht Ihnen
        ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu.<br />Hierzu
        sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit
        an uns wenden.<br /><br />Analyse-Tools und Tools von Drittanbietern<br /><br />Beim
        Besuch dieser Website kann Ihr Surf-Verhalten statistisch ausgewertet
        ...
        folgenden&nbsp;Datenschutzerklärung.<br /><br /><strong
          >2. Allgemeine Hinweise und Pflichtinformationen</strong
        ><br /><br /><strong>Datenschutz</strong><br /><br />Die Betreiber dieser
        ...
        und wofür wir sie nutzen. Sie erläutert auch, wie&nbsp;<br />und zu
        ...
        Daten vor dem Zugriff durch Dritte ist nicht&nbsp;möglich.<br /><br /><strong
          >Hinweis zur verantwortlichen Stelle</strong
        ><br /><br />Die verantwortliche Stelle für die Datenverarbeitung auf
        dieser Website ist:<br />TA Management GmbH<br /><br />Überseering 13 |
        22297 Hamburg<br />Telefon: 040/22 86 69 83-0<br /><br />E-Mail:
        info@ta-management.de<br />Vertreten durch Aaron Ebermann<br /><br />Verantwortliche
        ...
        Ä.)&nbsp;entscheidet.<br /><br /><strong>Speicherdauer</strong
        ><br /><br />Soweit innerhalb dieser Datenschutzerklärung keine
        ...
        erfolgt die Löschung nach Fortfall dieser Gründe. <br /><br /><strong
          >Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf
          dieser</strong
        ><br /><strong>Website</strong><br /><br />Sofern Sie in die
        ...
        einer ausdrücklichen Einwilligung in die
        ...
        rechtlichen Verpflichtung erforderlich sind auf Grundlage von Art. 6 Abs.
        1 lit. c DSGVO.&nbsp;Die Datenverarbeitung kann ferner auf Grundlage
        unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f&nbsp;DSGVO
        erfolgen. Über die jeweils im Einzelfall einschlägigen Rechtsgrundlagen
        wird in den folgenden&nbsp;Absätzen dieser Datenschutzerklärung
        informiert.<br /><br /><strong
          >Hinweis zur Datenweitergabe in die USA und sonstige
          Drittstaaten</strong
        ><br /><br />Wir verwenden unter anderem Tools von Unternehmen mit Sitz in
        den USA oder sonstigen<br />datenschutzrechtlich nicht sicheren
        Drittstaaten. Wenn diese Tools aktiv sind, können Ihre<br />personenbezogene
        ...
        vergleichbares Datenschutzniveau garantiert werden
        ...
        dass Sie als Betroffener hiergegen gerichtlich vorgehen könnten. Es kann
        daher nicht&nbsp;ausgeschlossen werden, dass US-Behörden (z. B.
        Geheimdienste) Ihre auf US-Servern befindlichen Daten
        zu&nbsp;Überwachungszwecken verarbeiten, auswerten und dauerhaft
        speichern. Wir haben auf diese&nbsp;Verarbeitungstätigkeiten keinen
        Einfluss.<br /><br /><strong
          >Widerruf Ihrer Einwilligung zur Datenverarbeitung</strong
        ><br /><br />Viele Datenverarbeitungsvorgänge sind nur mit Ihrer
        ...
        erfolgten&nbsp;Datenverarbeitung bleibt vom Widerruf unberührt.&nbsp;<br /><br /><strong
          >Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie
          gegen&nbsp;Direktwerbung (Art. 21 DSGVO)</strong
        ><br /><br />WENN DIE DATENVERARBEITUNG AUF GRUNDLAGE VON ART. 6 ABS. 1
        LIT. E ODER F DSGVO<br />ERFOLGT, HABEN SIE JEDERZEIT DAS RECHT, AUS
        GRÜNDEN, DIE SICH AUS IHRER BESONDEREN<br />SITUATION ERGEBEN, GEGEN DIE
        VERARBEITUNG IHRER PERSONENBEZOGENEN DATEN<br />WIDERSPRUCH EINZULEGEN;
        DIES GILT AUCH FÜR EIN AUF DIESE BESTIMMUNGEN GESTÜTZTES<br />PROFILING.
        DIE JEWEILIGE RECHTSGRUNDLAGE, AUF DENEN EINE VERARBEITUNG BERUHT,<br />ENTNEHMEN
        SIE DIESER DATENSCHUTZERKLÄRUNG. WENN SIE WIDERSPRUCH EINLEGEN,<br />WERDEN
        ...
        VERARBEITUNG<br />NACHWEISEN, DIE IHRE INTERESSEN, RECHTE UND FREIHEITEN
        ÜBERWIEGEN ODER DIE<br />VERARBEITUNG DIENT DER GELTENDMACHUNG, AUSÜBUNG
        ODER VERTEIDIGUNG VON<br />RECHTSANSPRÜCHEN (WIDERSPRUCH NACH ART. 21 ABS.
        1 DSGVO).<br />WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM
        ...
        DATEN ZUM ZWECKE DERARTIGER WERBUNG<br />EINZULEGEN; DIES GILT AUCH FÜR
        ...
        (WIDERSPRUCH&nbsp;NACH ART. 21 ABS. 2 DSGVO).<br /><br /><strong
          >Beschwerderecht bei der zuständigen Aufsichtsbehörde</strong
        ><br /><br />Im Falle von Verstößen gegen die DSGVO steht den Betroffenen
        ein Beschwerderecht bei einer<br />Aufsichtsbehörde, insbesondere in dem
        ...
        Rechtsbehelfe.<br /><br /><strong>Recht auf Datenübertragbarkeit</strong
        ...
        technisch machbar ist.<br /><br /><strong
          >Auskunft, Löschung und Berichtigung</strong
        ><br /><br />Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen
        ...
        können Sie sich jederzeit an uns wenden.<br /><br /><strong
          >Recht auf Einschränkung der Verarbeitung</strong
        ><br /><br />Sie haben das Recht, die Einschränkung der Verarbeitung Ihrer
        ...
        folgenden Fällen:<br />Wenn Sie die Richtigkeit Ihrer bei uns
        ...
        verlangen.<br />Wenn die Verarbeitung Ihrer personenbezogenen Daten
        ...
        personenbezogenen Daten zu verlangen.<br />Wenn Sie einen Widerspruch nach
        ...
        oder&nbsp;juristischen Person oder aus Gründen eines wichtigen
        öffentlichen Interesses der Europäischen Union oder&nbsp;eines
        Mitgliedstaats verarbeitet werden.<br /><br /><strong
          >SSL- bzw. TLS-Verschlüsselung</strong
        ><br /><br />Diese Seite nutzt aus Sicherheitsgründen und zum Schutz der
        ...
        SSL- bzw. TLS-Verschlüsselung aktiviert ist, können die Daten, die Sie an
        uns übermitteln, nicht&nbsp;von Dritten mitgelesen werden.<br /><br /><strong
          >3. Datenerfassung auf dieser Website</strong
        ><br /><br /><strong>Cookies</strong><br /><br />Unsere Internetseiten
        verwenden so genannte „Cookies“. Cookies sind kleine Datenpakete und
        ...
        (permanente Cookies) auf Ihrem Endgerät gespeichert. Session-Cookies
        werden nach Ende Ihres Besuchs automatisch gelöscht. Permanente Cookies
        bleiben auf Ihrem Endgerät gespeichert, bis Sie diese selbst löschen oder
        ...
        Zahlungsdienstleistungen).<br />Cookies haben verschiedene Funktionen.
        ...
        Bereitstellung<br />bestimmter, von Ihnen erwünschter Funktionen (z. B.
        für die Warenkorbfunktion) oder zur Optimierung der Website (z. B. Cookies
        zur Messung des Webpublikums) erforderlich sind (notwendige Cookies),
        werden auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO gespeichert, sofern
        ...
        DSGVO und § 25 Abs. 1<br />TTDSG); die Einwilligung ist jederzeit
        ...
        Funktionalität dieser Website eingeschränkt sein.<br />Soweit Cookies von
        Drittunternehmen oder zu Analysezwecken eingesetzt werden, werden wir Sie
        hierüber im Rahmen dieser Datenschutzerklärung gesondert informieren und
        ggf. eine Einwilligung abfragen.<br /><br /><strong
          >Kontaktformular</strong
        ><br /><br />Wenn Sie uns per Kontaktformular Anfragen zukommen lassen,
        ...
        Ihre Einwilligung weiter.<br />Die Verarbeitung dieser Daten erfolgt auf
        ...
        diese abgefragt wurde; die Einwilligung ist jederzeit widerrufbar.<br />Die
        ...
        Bestimmungen – insbesondere Aufbewahrungsfristen – bleiben unberührt.<br /><br /><strong
          >Anfrage per E-Mail, Telefon oder Telefax</strong
        ><br /><br />Wenn Sie uns per E-Mail, Telefon oder Telefax kontaktieren,
        wird Ihre Anfrage inklusive aller daraus<br />hervorgehenden
        ...
        ohne Ihre Einwilligung weiter. Die Verarbeitung dieser Daten erfolgt auf
        Grundlage von Art. 6 Abs. 1 lit. b DSGVO, sofern Ihre Anfrage mit der
        Erfüllung eines Vertrags zusammenhängt oder zur Durchführung
        vorvertraglicher Maßnahmen erforderlich ist. In allen übrigen Fällen
        beruht die Verarbeitung auf unserem berechtigten Interesse an der
        effektiven Bearbeitung der an uns gerichteten Anfragen (Art. 6 Abs. 1 lit.
        f DSGVO) oder auf Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) sofern
        diese abgefragt wurde; die Einwilligung ist jederzeit widerrufbar. Die von
        Ihnen an uns per Kontaktanfragen übersandten Daten verbleiben bei uns, bis
        Sie uns zur Löschung auffordern, Ihre Einwilligung zur Speicherung
        widerrufen oder der Zweck für die Datenspeicherung entfällt (z. B. nach
        ...
        unberührt.<br /><br /><strong>4. Plugins und Tools</strong
        ><br /><br /><strong>Font Awesome</strong><br /><br />Diese Seite nutzt
        zur einheitlichen Darstellung von Schriftarten und Symbolen Font Awesome.
        Anbieter ist die Fonticons, Inc., 6 Porter Road Apartment 3R, Cambridge,
        Massachusetts, USA.<br />Beim Aufruf einer Seite lädt Ihr Browser die
        benötigten Fonts in ihren Browsercache, um Texte, Schriftarten und Symbole
        korrekt anzuzeigen. Zu diesem Zweck muss der von Ihnen verwendete Browser
        Verbindung zu den Servern von Font Awesome aufnehmen. Hierdurch erlangt
        Font Awesome Kenntnis darüber, dass über Ihre IP-Adresse diese Website
        ...
        Zugriff auf Informationen im Endgerät des Nutzers (z. B.<br />Device-Fingerprinting)
        im Sinne des TTDSG umfasst. Die Einwilligung ist jederzeit widerrufbar.<br />Wenn
        Ihr Browser Font Awesome nicht unterstützt, wird eine Standardschrift von
        Ihrem Computer genutzt. Weitere Informationen zu Font Awesome finden Sie
        und in der Datenschutzerklärung von Font Awesome
        unter:&nbsp;https://fontawesome.com/privacy.<br /><br /><strong
          >Google reCAPTCHA</strong
        ><br /><br />Wir nutzen „Google reCAPTCHA“ (im Folgenden „reCAPTCHA“) auf
        dieser Website. Anbieter ist die Google Ireland Limited („Google“), Gordon
        House, Barrow Street, Dublin 4, Irland.<br />Mit reCAPTCHA soll überprüft
        werden, ob die Dateneingabe auf dieser Website (z. B. in einem<br />Kontaktformular)
        durch einen Menschen oder durch ein automatisiertes Programm erfolgt.
        Hierzu<br />analysiert reCAPTCHA das Verhalten des Websitebesuchers anhand
        verschiedener Merkmale. Diese<br />Analyse beginnt automatisch, sobald der
        Websitebesucher die Website betritt. Zur Analyse wertet<br />reCAPTCHA
        ...
        weitergeleitet.<br />Die reCAPTCHA-Analysen laufen vollständig im
        Hintergrund. Websitebesucher werden nicht darauf<br />hingewiesen, dass
        eine Analyse stattfindet.<br />Die Speicherung und Analyse der Daten
        erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der<br />Websitebetreiber
        hat ein berechtigtes Interesse daran, seine Webangebote vor
        missbräuchlicher<br />automatisierter Ausspähung und vor SPAM zu schützen.
        ...
        und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies
        ...
        jederzeit widerrufbar.<br /><br />Weitere Informationen zu Google
        reCAPTCHA entnehmen Sie den Google-&nbsp; Datenschutzbestimmungen und den
        Google Nutzungsbedingungen unter folgenden Links:<br />https://policies.google.com/privacy?hl=de
        und<br />https://policies.google.com/terms?hl=de.<br /><br />Quelle:<br />https://www.e-recht24.de<br /><br /><br />
      </p>
    </v-card>
  </template>
